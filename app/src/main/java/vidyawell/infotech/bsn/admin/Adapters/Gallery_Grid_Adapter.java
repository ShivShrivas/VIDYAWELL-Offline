...
public class Gallery_Grid_Adapter extends ArrayAdapter<Gallery_Grid_Helper> {
 ...
 */
    ...
    public Gallery_Grid_Adapter(@NonNull Context context, int resource, List<Gallery_Grid_Helper> gallery_helpers) {
        super(context, resource, gallery_helpers);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        Gallery_Grid_Adapter.ViewHolder holder = null;
        Gallery_Grid_Helper rowItem = getItem(position);

        LayoutInflater mInflater = (LayoutInflater) context
                .getSystemService(Activity.LAYOUT_INFLATER_SERVICE);
        if (convertView == null) {
            holder = new Gallery_Grid_Adapter.ViewHolder();

            typeFace = Typeface.createFromAsset(context.getAssets(),
                    "fonts/" + ServerApiadmin.FONT);
            applicationControllerAdmin=(ApplicationControllerAdmin)context.getApplicationContext();
            convertView = mInflater.inflate(R.layout.full_album_griditem, null);
            ...
            holder.staff_image3 =(RoundedImageView) convertView.findViewById(R.id.staff_image3);



            convertView.setTag(holder);
        }else
            holder = (Gallery_Grid_Adapter.ViewHolder) convertView.getTag();
        ...
        holder.event_description.setTypeface(typeFace);
            ...
            holder.event_title.setVisibility(View.GONE);
            ...
            holder.staff_image3.setImageURI(Uri.parse(imagerplace));
            Glide.get(context).clearMemory();
            Glide
                    .with(getContext())
                    .load(imagerplace)
                    .into(holder.staff_image3);
