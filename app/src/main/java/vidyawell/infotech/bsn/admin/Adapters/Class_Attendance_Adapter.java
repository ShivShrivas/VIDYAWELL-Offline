...
public class Class_Attendance_Adapter  extends ArrayAdapter<Class_Attendance_Helper> {
    ...
    public Class_Attendance_Adapter(@NonNull Context context, int resource, List<Class_Attendance_Helper> class_attendance_helpers) {
        super(context, resource, class_attendance_helpers);
        this.context = context;
        this.class_attendance_helpers = class_attendance_helpers;
...
*/
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        Class_Attendance_Helper rowItem = getItem(position);
        LayoutInflater mInflater = (LayoutInflater) context
                .getSystemService(Activity.LAYOUT_INFLATER_SERVICE);
        if (convertView == null) {
            //holder = new ViewHolder();
            holder = new Class_Attendance_Adapter.ViewHolder();
            convertView = mInflater.inflate(R.layout.class_attendance_item_list, null);
            ...
            holder = (Class_Attendance_Adapter.ViewHolder) convertView.getTag();
        ...
        holder.stu_name.setText(rowItem.getstu_name());
        holder.studentid.setText(rowItem.getstu_code());
        holder.studentcount.setText(rowItem.getstu_count());
        holder.father_name.setText("Father's Name: "+rowItem.getFatherName());
        holder.Roll_no.setText("Roll No: "+"Not Assigned");
        holder.stu_id.setText("StudentId: "+rowItem.getStudentId());
        ...
        final Class_Attendance_Helper temp = getItem(position);
        final ViewHolder finalHolder = holder;
        final Class_Attendance_Helper temp2 = getItem(position);
        final ViewHolder finalHolder2 = holder;
        final Class_Attendance_Helper temp3 = getItem(position);
