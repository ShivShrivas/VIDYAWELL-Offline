...
import vidyawell.infotech.bsn.admin.Adapters.Class_Attendance_Adapter;
...
public class Class_Attendance extends AppCompatActivity implements Class_Attendance_Adapter.customButtonListener,Class_Attendance_Adapter.customButtonListener2,Class_Attendance_Adapter.customButtonListener3 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_class__attendance);
        ...
        fontChanger.replaceFonts((RelativeLayout) findViewById(R.id.class_attendance_layout));
        ...
        SpannableString str = new SpannableString("Class Attendance");
        ...
        ViewGroup footer = (ViewGroup) inflater.inflate(R.layout.classatt_listview_footer, class_attendance_list, false);
        buttonfooter = (Button) footer.findViewById(R.id.att_submit_footer);
        buttonfooter.setFocusable(false);
        buttonfooter.setText("SUBMIT");
        class_attendance_list.addFooterView(footer, null, false);
...
*/
    ...
    private void retrieveValuesFromListMethod(Map map) {
        ...
        while(itr.hasNext())
        {
            ...
            ar.add(value);
            Student_Attendance_Helper.StudentDetails sd=st.new StudentDetails();
    ...
    @Override
    public void onButtonClickListner(int position, Class_Attendance_Helper value) {
        //AttendanceAbbrId_present =value.AttendanceAbbrId;
      //  Abbreviation="P";
        String studentid = value.getstu_code();
    ...
    @Override
    public void onButtonClickListner2(int position, Class_Attendance_Helper value) {
        String studentid = value.getstu_code();
    ...
    @Override
    public void onButtonClickListner3(int position, Class_Attendance_Helper value) {
        String studentid = value.getstu_code();
    ...
    private class StudentAttendance extends AsyncTask<String, String, Integer> {
        ...
        protected Integer doInBackground(String... strings) {
            ...
            String response=josnparser.executePostinsert(applicationController.getServicesapplication()+ServerApiadmin.STUDENT_ATTENDANCE_SUBMIT,ParastudentAtt(applicationController.getschoolCode(),applicationController.getBranchcode(),applicationController.getSeesionID(),applicationController.getFyID()),"1");
        ...
        protected void onPostExecute(Integer s) {
            ...
            switch (s){
                ...
                case -2:
                    Snackbar snackbar = Snackbar
                            .make(class_attendance_layout, "Student List not Found. Please Try Again", Snackbar.LENGTH_LONG)
    ...
    public String ParastudentAtt(String SchoolCode,String BranchCode,String SessionId,String FYId){
        ...
        try {
            ...
            for (Student_Attendance_Helper.StudentDetails pn : st.getStudentList() ) {
                JSONObject pnObj = new JSONObject();
                pnObj.put("StudentCode", pn.getStudentCode());
                pnObj.put("AttendanceAbbrId", pn.getAttendanceAbbrId());
                pnObj.put("SrNo", pn.getSrNo());
                pnObj.put("CreatedBy", pn.getCreatedBy());
                pnObj.put("UpdatedBy", pn.getCreatedBy());
                jsonArr.put(pnObj);
            }
...
//////////update submit api ///////////////////////////////
    ...
    private class StudentAttendanceupdate extends AsyncTask<String, String, Integer> {
        ...
        protected Integer doInBackground(String... strings) {
            int status=0;
            JsonParser josnparser=new JsonParser(getApplicationContext());
            String response=josnparser.executePostinsert(applicationController.getServicesapplication()+ServerApiadmin.STUDENT_ATTENDANCE_SUBMIT_UPDATE,ParastudentAtt1(applicationController.getschoolCode(),applicationController.getBranchcode(),applicationController.getSeesionID(),applicationController.getFyID()),"1");
    ...
    private void showSuccessDialog() {
        final Dialog dialog = new Dialog(Class_Attendance.this,R.style.Theme_AppCompat_Dialog_Alert);
        ...
        text_label.setText("Class Attendance");
        TextView text_message = (TextView) dialog.findViewById(R.id.text_message);
        text_message.setText("Class Attendance submit successfully");
    ...
    private class StudentList extends AsyncTask<String, String, Integer> {
        ...
        protected Integer doInBackground(String... strings) {
            int status=0;
            JsonParser josnparser=new JsonParser(getApplicationContext());
            Log.d("TAG", "doInBackground:get Student list  "+applicationController.getServicesapplication()+ServerApiadmin.STUDENT_LIST+"//////////"+ParastudentList(applicationController.getschoolCode(),applicationController.getBranchcode(),applicationController.getSeesionID(),applicationController.getFyID()));
            ...
            if(response!=null){
                if (response.length()>5){
                    try {
                        ...
                        class_attendance_helpers = new ArrayList<>();
                        arraylist_codes=new String[array.length()];
                        for (int i = 0; i < array.length(); i++) {
                            JSONObject object= array.getJSONObject(i);
                            String   StudentCode=object.getString("StudentCode");///StudentCode StudentId
                            ...
                            //Class_Attendance_Helper item = new Class_Attendance_Helper(StudentName+" ("+StudentCode+")",StudentCode, i + 1 + " .",FatherName,AttendanceDate,AttendanceAbbrId);
                            Class_Attendance_Helper item = new Class_Attendance_Helper(StudentName,StudentCode, i + 1 + " .",FatherName,AttendanceDate,AttendanceAbbrId,StudentId);
                            class_attendance_helpers.add(item);

                            arraylist_codes[i]=StudentCode;
        ...
        protected void onPostExecute(Integer s) {
            ...
            switch (s){
                case 1:
                    Class_Attendance_Adapter adapter = new Class_Attendance_Adapter(Class_Attendance.this,R.layout.class_attendance_item_list, class_attendance_helpers);
                    class_attendance_list.setAdapter(adapter);
                    adapter.setCustomButtonListner(Class_Attendance.this);
                    adapter.setCustomButtonListner2(Class_Attendance.this);
                    adapter.setCustomButtonListner3(Class_Attendance.this);
                    animationDown = AnimationUtils.loadAnimation(getApplicationContext(), R.anim.slide_down);
                    list_classatt.setVisibility(View.VISIBLE);
                    class_attendance_list.setVisibility(View.VISIBLE);
                    list_classatt.startAnimation(animationDown);
                    ...
                    if(list_button_show==false){
                        ...
                        Snackbar snackbar = Snackbar
                                .make(class_attendance_layout, "Class Attendance has been Submitted for this Date", Snackbar.LENGTH_LONG)
                ...
                case -2:
                    Snackbar snackbar = Snackbar
                            .make(class_attendance_layout, "Student List not Found for that Class or Section. Please Try Again", Snackbar.LENGTH_LONG)
                            .setAction("Try Again", new View.OnClickListener() {
                                @Override
                                public void onClick(View view) {
                                   /* Snackbar snackbar1 = Snackbar.make(loginlayout, "Message is restored!", Snackbar.LENGTH_SHORT);
                    ...
                    snackbar.show();
                    list_classatt.setVisibility(View.GONE);
                    class_attendance_list.setVisibility(View.GONE);
                    break;
                case -1:
                    Snackbar snackbar1 = Snackbar
                            .make(class_attendance_layout, "Network Problem. Please Try Again", Snackbar.LENGTH_LONG)
    ...
    public class SelectclassDetails extends AsyncTask<String, String, Integer> {
        ProgressDialog progressDialog = new ProgressDialog(Class_Attendance.this);
        @Override
        protected void onPreExecute() {
            progressDialog = ProgressDialog.show(Class_Attendance.this, "", "Please Wait...", true);
        ...
        protected Integer doInBackground(String... strings) {
            int status=0;
            JsonParser josnparser=new JsonParser(getApplicationContext());
            Log.d("TAG", "doInBackground:SelectclassDetails "+applicationController.getServicesapplication()+ServerApiadmin.ATTENDANCE_SELECT+"////////////"+Paradetails(applicationController.getschoolCode(),applicationController.getBranchcode(),applicationController.getSeesionID(),applicationController.getFyID()));
        ...
        protected void onPostExecute(Integer s) {
           ...
           progressDialog.dismiss();
            switch (s){
                ...
                case -1:
                    Snackbar snackbar1 = Snackbar
                            .make(class_attendance_layout, "Data Not Found", Snackbar.LENGTH_LONG)
                            .setAction("Try Again", new View.OnClickListener() {
                                @Override
                                public void onClick(View view) {
                                   /* Snackbar snackbar1 = Snackbar.make(loginlayout, "Message is restored!", Snackbar.LENGTH_SHORT);
    ...
    //////////////////////////////////////////////////////////////////////////////////////////// AbbreviationList////////////
    public class AbbreviationList extends AsyncTask<String, String, Integer> {
     // ProgressDialog progressDialog = new ProgressDialog(Class_Attendance.this);
        @Override
        protected void onPreExecute() {
           // progressDialog = ProgressDialog.show(Class_Attendance.this, "", "Please Wait...", true);
        ...
        protected Integer doInBackground(String... strings) {
            int status=0;
            JsonParser josnparser=new JsonParser(getApplicationContext());
            Log.d("TAG", "doInBackground:AbbreviationList  "+applicationController.getServicesapplication()+ServerApiadmin.API_ABBREVATION+"////////"+ParaAbb(applicationController.getschoolCode(),applicationController.getBranchcode(),applicationController.getSeesionID(),applicationController.getFyID()));
    ...
    /////////////////////////////////////select branch name///////////////////////////////
    public class SelectBranch extends AsyncTask<String, String, Integer> {
        ProgressDialog progressDialog = new ProgressDialog(Class_Attendance.this);
        @Override
        protected void onPreExecute() {
            progressDialog = ProgressDialog.show(Class_Attendance.this, "", "Please Wait...", true);
        ...
        protected Integer doInBackground(String... strings) {
            int status=0;
            JsonParser josnparser=new JsonParser(getApplicationContext());
            Log.d("TAG", "doInBackground:SelectBranch "+applicationController.getServicesapplication()+ServerApiadmin.ATTENDANCE_SELECTBRANCH+"///////"+ParaBranch(applicationController.getschoolCode(),applicationController.getBranchcode(),applicationController.getSeesionID()));
        ...
        protected void onPostExecute(Integer s) {
            ...
            switch (s){
                ...
                case -1:
                    Snackbar snackbar1 = Snackbar
                            .make(class_attendance_layout, "Branch Data Not Found", Snackbar.LENGTH_LONG)
                            .setAction("Try Again", new View.OnClickListener() {
                                @Override
                                public void onClick(View view) {
                                   /* Snackbar snackbar1 = Snackbar.make(loginlayout, "Message is restored!", Snackbar.LENGTH_SHORT);
    ...
    private class Studentapicount extends AsyncTask<String, String, Integer> {
        ...
        protected Integer doInBackground(String... strings) {
            int status=0;
            JsonParser josnparser=new JsonParser(getApplicationContext());
            Log.d("TAG", "doInBackground:student present count "+applicationController.getServicesapplication()+ ServerApiadmin.STUDENT_ATTENDANCE+"///////"+Para(student_action,applicationController.getBranchcode(),applicationController.getschoolCode(),applicationController.getSeesionID(),applicationController.getFyID(),applicationController.getDate()));
        ...
        protected void onPostExecute(Integer s) {
            ...
            switch (s){
                ...
                case -2:
                    Snackbar snackbar = Snackbar
                            .make(class_attendance_layout, "Student Attendance not found for selected date", Snackbar.LENGTH_LONG)
                            .setAction("Try Again", new View.OnClickListener() {
                                @Override
                                public void onClick(View view) {
                                   /* Snackbar snackbar1 = Snackbar.make(loginlayout, "Message is restored!", Snackbar.LENGTH_SHORT);
