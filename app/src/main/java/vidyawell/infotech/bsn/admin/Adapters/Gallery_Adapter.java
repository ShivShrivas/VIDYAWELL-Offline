...
public class Gallery_Adapter extends ArrayAdapter<Gallery_Helper> {
 ...
 */
    ...
    public Gallery_Adapter(@NonNull Context context, int resource, List<Gallery_Helper> gallery_helpers) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        Gallery_Adapter.ViewHolder holder = null;
        Gallery_Helper rowItem = getItem(position);

        LayoutInflater mInflater = (LayoutInflater) context
                .getSystemService(Activity.LAYOUT_INFLATER_SERVICE);
        if (convertView == null) {
            holder = new Gallery_Adapter.ViewHolder();

            typeFace = Typeface.createFromAsset(context.getAssets(),
                    "fonts/" + ServerApiadmin.FONT);
            applicationControllerAdmin=(ApplicationControllerAdmin)context.getApplicationContext();
            convertView = mInflater.inflate(R.layout.gallery_item_list, null);
            holder = new Gallery_Adapter.ViewHolder();
            ...
            holder.transection_id =(TextView) convertView.findViewById(R.id.transection_id);
            ...
            holder = (Gallery_Adapter.ViewHolder) convertView.getTag();
